...
refactor (`designs/deferal-block-scoped-use.md` stays an independent proposal; §8).
...
`designs/deferal-block-scoped-use.md`'s unified `Scope` (one object carrying name table +
