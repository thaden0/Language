...
| now-ish (no code) | **Owner ruling on the cycle policy** (§4.3.3) — a decision, not an implementation. | Recorded in §10 when made. Recommendation surfaced to the owner 2026-07-17 (§10); **pending**. |
