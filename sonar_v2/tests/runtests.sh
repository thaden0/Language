#!/usr/bin/env bash
# Sonar Track 10 §4 — the differential engine-matrix corpus runner.
#
# Every test is a trident project directory holding a <name>.expected golden and
# a trident.toml (dep on ../.. as Sonar). Each test runs on the tree-walk oracle,
...
# Examples ship a scripted-mode flag: SONAR_SCRIPT=1 binds ScriptedInput +
